...
(function($) {
    var CCForm = function(config) {
        ...
        this.config = {
            ...
            url: "//post.aihuagrp.com/email", // 提交url
            jumpUrl: null, // 提交成功后跳转的url
            callback: null, // 执行成功后的回调			
            delay: 0, // 自定义延迟时间
        ...
        // 加载http, https 判断
		this.config._http = 'https:' == document.location.protocol ? 'https:' : 'http:';
		
        this.loadCSS(this.config._http+'//post.aihuagrp.com/assets/js/libs/cc/CCForm.css');
