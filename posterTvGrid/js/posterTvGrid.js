...
(function(jq){
	var posterTvGrid = function(o, options, data){
		...
		this.data = data || {};
		if(parseInt(jq('body').outerWidth())>1045){
	...
	posterTvGrid.prototype = {
		reset: function(options){
			...
			this.preLeft = 0;
			this.nextLeft = this.options.width-384;
			this.preNLeft = -384;
			this.nextNLeft = this.options.width;
			this.pageNowLeft = (this.options.width-384)/2
			this.drawContent();
		},
		drawContent: function(){
			...
			for(var item=0, i = 1, l= this.data.length ; item < l ; ++item, ++i){
				...
				var unitItem = '<a href="'+this.data[item].url+'" onclick="'+this.data[item].onclick+'" target="_blank" class="elementLink">';
				unitItem += '</a>';
		...
		initContent: function(){
			...
			this.parent.find(".contentHolderUnit:nth-child("+this.pageNow+")").css({width:'384px',height:'290px', opacity: 1, left: this.pageNowLeft+'px', zIndex: 3, marginTop: 0});
			...
			this.parent.find(".contentHolderUnit:nth-child("+pre+")").css({opacity: 1, left: this.preLeft+'px',height: '236px', width: '384px', zIndex: 0, marginTop: '23px'});
			...
			this.parent.find(".contentHolderUnit:nth-child("+next+")").css({opacity: 1, left: this.nextLeft+'px',height: '236px', width: '384px', zIndex: 0, marginTop: '23px'});
		...
		turnpage: function(page, dir){
			...
			var run = function(page, dir, t){
				...
				if(dir == 'left'){					
					...
					_this.parent.find(".contentHolderUnit:nth-child("+pre+")").animate({opacity: 1, left: _this.preLeft+'px', height: '236px', width: '384px', zIndex: 2, marginTop: '23px'}, t);
					...
					_this.parent.find(".contentHolderUnit:nth-child("+page+")").animate({opacity: 1, left: _this.pageNowLeft+'px', height: '290px', width: '384px', zIndex: 3, marginTop: '0'}, t);
					...
					_this.parent.find(".contentHolderUnit:nth-child("+next+")").css({opacity: 0, left: _this.nextNLeft+'px', height: '236px', width: '384px', zIndex: 2, marginTop: '85px'});
					_this.parent.find(".contentHolderUnit:nth-child("+next+")").animate({opacity: 1, left: _this.nextLeft+'px', height: '236px', width:"384px", zIndex: 2, marginTop: '23px'}, t);
					...
					_this.parent.find(".contentHolderUnit:nth-child("+preP+")").animate({width:'384px',height:'236px', opacity: 0, left:_this.preNLeft+'px', zIndex:0, marginTop: '85px'},t, "", function(){_this.locked=false;});
					...
					_this.parent.find(".contentHolderUnit:nth-child("+page+")").animate({opacity: 1, left: _this.pageNowLeft+'px', height: '290px', width: '384px', zIndex: 3, marginTop: '0px'}, t);
					_this.parent.find(".contentHolderUnit:nth-child("+page+") .elementOverlay").css({opacity:0});
					_this.parent.find(".contentHolderUnit:nth-child("+page+") .leftShadow").css({opacity:1});
					_this.parent.find(".contentHolderUnit:nth-child("+page+") .rightShadow").css({opacity:1});
					
					_this.parent.find(".contentHolderUnit:nth-child("+pre+")").css({opacity: 0, left: _this.preNLeft+'px', height: '236px', width: '384px', zIndex: 2, marginTop: '85px'});
					_this.parent.find(".contentHolderUnit:nth-child("+pre+")").animate({opacity: 1, left: _this.preLeft+'px', height: '236px', width: '384px', zIndex: 2, marginTop: '23px'}, t);
					_this.parent.find(".contentHolderUnit:nth-child("+pre+") .elementOverlay").css({opacity:0.4});
					_this.parent.find(".contentHolderUnit:nth-child("+pre+") .leftShadow").css({opacity:0});
					_this.parent.find(".contentHolderUnit:nth-child("+pre+") .rightShadow").css({opacity:0});
					...
					_this.parent.find(".contentHolderUnit:nth-child("+nextN+")").animate({width:'384px',height:'236px', opacity: 0, left:_this.nextNLeft+'px', zIndex:0, marginTop: '85px'}, t, "",function(){_this.locked=false;});
				}
