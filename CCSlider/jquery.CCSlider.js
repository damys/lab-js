...
;(function($){
    ...
    Slider.prototype = {
        init: function(){
            ...
            this.options.isFlexible && $(window).on('resize.ccSlider', $.proxy(this, 'resize'));
        ...
        setLayout: function(){
            ...
            this.$container.css(css.container).wrap('<div class="ccSlider-wrap"/>');
            this.$wrap = this.$container.parent();
            this.$wrap.css(css.wrap);
            if(this.options.isShowTitle){
                this.$title = $('<div class="ccSlider-title"/>').insertAfter(this.$container);
                this.setTitle();
            }
            if(this.options.isShowPage){
                this.$pages = $('<div class="ccSlider-pages">'+this.getPages()+'</div>').insertAfter(this.$container);
                this.pagesSwitch();
            }
            if(this.options.isShowControls){
                this.$prev = $('<div class="ccSlider-btn ccSlider-btn-prev"></div>');
                this.$next = $('<div class="ccSlider-btn ccSlider-btn-next"></div>');
